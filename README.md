<div align="center">
  ...
  <a href="https://khushisavarn.github.io/solutry/"><strong>➥ Live Demo</strong></a>
...
```bash
sudo git clone https://github.com/khushisavarn/solutry.git
```

Windows:

```bash
git clone https://github.com/khushisavarn/solutry.git
```
